...
export const CATEGORIES: CategoryInfo[] = [
  ...
  // ------------------------------------------------------------------
  {
    ...
    iconName: 'BookOpen',
    bgGradient: 'from-emerald-500/10 to-amber-500/10',
    accentColor: 'text-emerald-700 bg-emerald-50 border-emerald-200',
    infoPoints: [
      'Cover custom nama almarhum/almarhumah & tanggal acara',
      'Cocok untuk tahlilan, haul, dan kenang-kenangan acara',
      'Isi & jumlah halaman menyesuaikan permintaan',
    ],
  },
  {
    ...
    accentColor: 'text-stone-700 bg-stone-50 border-stone-200',
    infoPoints: [
