...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section id="tentang-section" className="py-8 sm:py-16 bg-[#f3efe6] border-t border-stone-200/80">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7 space-y-5">
            ...
            <div className="space-y-3.5 text-sm sm:text-base text-stone-600 leading-relaxed">
              <p>
                <strong>Rumah Ijo</strong> menyediakan kebutuhan <strong>undangan</strong>, <strong>souvenir</strong>, <strong>percetakan</strong>, dan <strong>sablon</strong> untuk berbagai acara.
              </p>
              <p>
