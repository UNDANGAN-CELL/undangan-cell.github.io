...
import { MessageCircle, Heart, Phone, Clock, Mail } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-stone-800">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-stone-400 max-w-sm leading-relaxed">
              Solusi percetakan profesional dan terpercaya untuk undangan pernikahan, sunatan, aqiqah, souvenir, dan kebutuhan acara dengan hasil cetak rapi, cepat, dan bergaransi.
            </p>
            ...
            <div className="pt-2">
              ...
              >
                ...
                <span>Hubungi Admin WhatsApp ({SITE_CONFIG.phoneDisplay})</span>
              </a>
            </div>
          </div>
              ...
              {[
                ...
                <li key={m.id}>
                  <button
                    ...
                    className="text-stone-400 hover:text-emerald-400 transition cursor-pointer text-left"
                  >
                    {m.label}
                  </button>
                </li>
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <div className="space-y-2.5 text-xs text-stone-400">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <span className="block text-stone-500 text-[10px]">WhatsApp Resmi:</span>
                  <a
                    href={directWhatsAppUrl}
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <span className="block text-stone-500 text-[10px]">Jam Layanan:</span>
                  <span className="text-stone-300">{SITE_CONFIG.workingHours}</span>
                </div>
              </div>

              <div className="pt-2 text-[11px] text-stone-500 leading-relaxed">
                Semua pemesanan final dan revisi desain dikonfirmasi langsung melalui obrolan WhatsApp untuk kemudahan dan transparansi.
              </div>
            </div>
          </div>
