          ...
          <div className="lg:col-span-7 space-y-2 sm:space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2">
              <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-emerald-100/80 border border-emerald-300/70 text-emerald-900 text-xs sm:text-sm font-bold tracking-wide shadow-xs">
                ...
                <span>Cetak Undangan • Kemasan • Buku</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 sm:flex items-stretch sm:items-center justify-center lg:justify-start gap-1.5 sm:gap-3 pt-1 sm:pt-2">
              <button
                id="hero-cta-catalog-btn"
                onClick={onExploreCatalog}
                className="inline-flex items-center justify-center gap-1 px-2 py-2.5 sm:gap-2.5 sm:px-6 sm:py-3.5 text-[10px] sm:text-base font-bold text-white bg-gradient-to-r from-stone-900 via-stone-900 to-stone-800 hover:from-emerald-900 hover:to-teal-900 active:scale-98 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer min-h-[48px]"
              >
                <span>Katalog</span>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-1 px-2 py-2.5 sm:gap-2 sm:px-6 sm:py-3.5 text-[10px] sm:text-base font-bold text-white bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 active:scale-98 rounded-xl shadow-md hover:shadow-emerald-600/30 transition-all duration-200 min-h-[48px]"
              >
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-1 text-[10px] sm:text-sm font-semibold text-emerald-800 hover:text-emerald-950 bg-emerald-50 hover:bg-emerald-100/80 border border-emerald-200/80 py-3 px-4 rounded-xl transition cursor-pointer min-h-[48px]"
              >
