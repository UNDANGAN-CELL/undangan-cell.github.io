...
import { ArrowRight, MessageCircle, Sparkles, ShieldCheck, Heart, Award, CheckCircle } from 'lucide-react';
...
export const Hero: React.FC<HeroProps> = ({ onExploreCatalog, onOpenCalculator }) => {
  const heroSlides = [
    ...
    '2202.jpg',
    '88164.jpg',
  ].map((filename) => `${import.meta.env.BASE_URL}images/hero/${filename.replace('.jpg', '.webp')}`);
          ...
          <div className="lg:col-span-7 space-y-5 sm:space-y-6 text-center lg:text-left">
            ...
            <div className="pt-5 sm:pt-6 border-t border-stone-200/80 grid grid-cols-3 gap-2 sm:gap-4 text-center sm:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-2 p-2 rounded-xl bg-white/60 sm:bg-transparent">
                ...
                <div>
                  <div className="text-xs font-bold text-stone-900 leading-tight">Pilihan Bahan</div>
                  <div className="text-[11px] text-stone-500 mt-0.5">Sesuaikan dengan produk</div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-2 p-2 rounded-xl bg-white/60 sm:bg-transparent">
                ...
                <div>
                  <div className="text-xs font-bold text-stone-900 leading-tight">Pesan via WhatsApp</div>
                  <div className="text-[11px] text-stone-500 mt-0.5">Praktis & langsung admin</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="relative rounded-2xl sm:rounded-3xl bg-white p-3 sm:p-4 shadow-xl border border-stone-200/90">
                ...
                <div className="mt-3 pt-2.5 border-t border-stone-100 flex items-center justify-between text-[11px] text-stone-600 font-medium px-1">
                  <span>⚡ Jadwal sesuai pesanan</span>
                  <span>•</span>
