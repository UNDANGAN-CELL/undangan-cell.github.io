...
export const Hero: React.FC<HeroProps> = ({ onExploreCatalog, onOpenCalculator }) => {
  ...
  return (
    <section
      id="hero-section"
      className="relative pt-24 pb-6 sm:pt-36 sm:pb-20 md:pt-40 md:pb-24 overflow-hidden bg-gradient-to-b from-[#f4efe5] via-[#f7f5ef] to-[#f3efe6] border-b border-stone-200/70"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-3 sm:space-y-6 text-center lg:text-left">
            ...
            {/* Main Headline */}
            <h1 className="font-serif text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-stone-900 tracking-tight leading-[1.15]">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-2 sm:gap-3 pt-1 sm:pt-2">
              <button
            ...
            <div className="pt-3 sm:pt-6 border-t border-stone-200/80 grid grid-cols-3 gap-2 sm:gap-4 text-center">
