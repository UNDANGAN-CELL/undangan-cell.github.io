...
const categoryThemeStyles: Record<string, typeof DEFAULT_THEME> = {
  ...
  'Sablon Cup': {
    ...
    cardHover: 'hover:border-cyan-300 hover:shadow-cyan-100/50',
    iconBg: 'bg-gradient-to-br from-cyan-600 to-teal-700 text-white shadow-cyan-200',
    textHighlight: 'group-hover:text-cyan-700',
  },
  'Stiker Label': {
    badge: 'bg-blue-100 text-blue-800 border-blue-200',
    cardHover: 'hover:border-blue-300 hover:shadow-blue-100/50',
  ...
  'Buku Yasin': {
    badge: 'bg-emerald-100 text-emerald-800 border-emerald-200',
    cardHover: 'hover:border-emerald-300 hover:shadow-emerald-100/50',
    iconBg: 'bg-gradient-to-br from-emerald-600 to-amber-600 text-white shadow-emerald-200',
    textHighlight: 'group-hover:text-emerald-700',
  },
  'Nota, Kwitansi & Buku Rekapan': {
    badge: 'bg-stone-100 text-stone-800 border-stone-200',
    cardHover: 'hover:border-stone-300 hover:shadow-stone-100/50',
    iconBg: 'bg-gradient-to-br from-stone-600 to-slate-700 text-white shadow-stone-200',
    textHighlight: 'group-hover:text-stone-700',
  },
  Brosur: {
