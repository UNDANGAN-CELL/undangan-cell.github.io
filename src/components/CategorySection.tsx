...
export const CategorySection: React.FC<CategorySectionProps> = ({
  ...
  return (
    <section id="kategori-section" className="py-8 sm:py-16 bg-[#faf7f2] border-y border-stone-200/80">
            ...
            return (
              ...
              >
                <div>
                  ...
                  <h3 className={`text-base sm:text-lg font-bold text-stone-900 text-center ${theme.textHighlight} transition-colors`}>
                    {cat.title}
                  </h3>

                  <p className="text-xs text-stone-500 mt-1 leading-relaxed text-center">
                    {cat.subtitle}
                  </p>
