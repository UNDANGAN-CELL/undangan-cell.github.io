...
import { Search, SlidersHorizontal, X, ArrowUpDown, Tag, Sparkles, MessageCircle, PackageSearch } from 'lucide-react';
  ...
  return (
    <section id="katalog-section" className="py-16 bg-[#f4f0e6] border-b border-stone-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {products.length === 0 ? (
          <div className="bg-[#faf8f4] rounded-2xl p-8 sm:p-12 text-center max-w-xl mx-auto border border-amber-200/80 space-y-4">
            <div className="w-14 h-14 rounded-full bg-amber-50 text-amber-600 flex items-center justify-center mx-auto">
              <PackageSearch className="w-7 h-7" />
            </div>
            <div>
              <h3 className="text-base sm:text-lg font-bold text-stone-800">{comingSoonTitle}</h3>
              <p className="text-xs sm:text-sm text-stone-500 mt-1.5 leading-relaxed">{comingSoonDescription}</p>
            </div>
            <a
