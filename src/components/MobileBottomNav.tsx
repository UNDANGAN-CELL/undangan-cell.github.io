...
import { Home, Layers, Calculator, MessageCircle } from 'lucide-react';
    ...
    >
      <div className="flex items-center justify-around max-w-md mx-auto">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center py-1 px-2.5 rounded-xl transition cursor-pointer min-w-[64px] ${
            activeSection === 'home'
