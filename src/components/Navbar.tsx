      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <button
            ...
            className="shrink-0 flex items-center cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 rounded-lg lg:static lg:translate-x-0 lg:translate-y-0 max-lg:absolute max-lg:left-1/2 max-lg:-translate-x-1/2"
          >
            <img
              ...
              className={`w-auto object-contain object-left transition-all duration-300 ${
                isScrolled ? 'h-14 sm:h-14 lg:h-14' : 'h-16 sm:h-16 lg:h-16'
              }`}
            />
          </button>
