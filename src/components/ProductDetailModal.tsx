              ...
              <div className="space-y-4">
                ...
                <div className="p-3.5 rounded-xl bg-emerald-50/70 border border-emerald-200/60 flex items-center justify-between">
                  <div>
                    {product.price > 0 ? (
                      <>
                        <span className="text-xs text-stone-500 block">Harga undangan saja • Mulai dari:</span>
                ...
                <div className="p-3 rounded-xl bg-amber-50 border border-amber-200 text-[11px] text-amber-900 leading-relaxed">Plastik, label, amplop khusus, dan finishing seperti foil/emboss adalah <strong>opsi tambahan</strong> dan belum termasuk harga undangan di atas.</div>
