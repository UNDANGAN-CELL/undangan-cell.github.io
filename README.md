# Rumah Ijo — Website Katalog Percetakan, Sablon, Undangan & Souvenir

Website resmi **Rumah Ijo** (Percetakan & Sablon) dengan sistem pemesanan langsung terintegrasi ke **WhatsApp** (`083170819117`).
...
export const SITE_CONFIG = {
  brandName: 'Rumah Ijo',                     // Ganti nama brand di sini
  tagline: 'Percetakan & Sablon', // Ganti tagline
...
1. Simpan dan push kode ke repository GitHub:
   ...
   git init
   git add .
   git commit -m "Initial commit Rumah Ijo website"
   git branch -M main
   git remote add origin https://github.com/USERNAME/rumahijo.git
